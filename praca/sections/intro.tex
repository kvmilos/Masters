...
Middle Polish texts in~KorBa \parencite{Gruszczynski2022KorBa}
and the emerging Middle Polish Dependency Treebank (MPDT) are annotated in~a~Polish-specific scheme
\parencite{Wieczorek2025TowardsMPDT}.
This limits their interoperability with~UD-based tools and doesn't allow for straightforward comparative studies with~other languages.
