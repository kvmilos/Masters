...
Middle Polish Dependency Treebank (MPDT) is a syntactically annotated subset of KorBa that adds a dependency layer on top of KorBa’s tokenization, lemmas, POS, and features for selected 17th–18th-century Polish texts \parencite{Wieczorek2025TowardsMPDT}. The annotation follows PDB conventions, ensuring compatibility with contemporary Polish resources while capturing historical phenomena.

The current MPDT release contains 2,018 sentences totaling 47,273 tokens, with an average sentence length of 23.43 tokens. No sentence has more than one root, and all sentences are cycle-free. However, 3,748 non-projective edges occur across the dataset, affecting 879 sentences, reflecting the discontinuous structures typical of historical Polish. There are 45 distinct POS tags and 27 distinct dependency relations in the current MPDT version.
