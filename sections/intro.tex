...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Chapter~5: Validation and Outcomes.} Presents the formal validation methodology using the official UD validator, outlines the iterative refinement cycle guided by validator feedback, and confirms zero-error conformance under UD~v2.17 (\texttt{--lang pl}). It concludes with the public MPDT-UD~1.0 release, its licensing, integration into the UD ecosystem, and remaining limitations with directions for future work.
\end{itemize}
