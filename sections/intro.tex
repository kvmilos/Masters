...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Chapter~6: Cognitive Science Perspective on MPDT Conversion: Concluding Remarks.} Positions the converter and MPDT-UD as reusable infrastructure, sketches applications in historical syntax and diachronic NLP, and relates the resource to questions about processing constraints and category change over time, concluding with proposals for future extensions of the pipeline and treebank.
\end{itemize}
