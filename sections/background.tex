...
lexicalist model \parencite{nivre-etal-2020-universal, de-marneffe-manning-nivre-zeman-2021}. UD serves as both a theoretical framework and a practical collection of treebanks—currently the largest repository of over 200 treebanks for more than 150 languages.\footnote{Universal Dependencies, \url{https://universaldependencies.org}, accessed 2025-10-10.} Beyond contemporary language varieties, UD also includes historical treebanks such as Middle French Profiterole \parencite{prevost2024profiterole} and Old English Cairo \parencite{levine2025buildingudcairoold}, demonstrating that the framework can be applied to earlier stages of languages as well. It is widely adopted in~NLP and linguistic typology studies, and is maintained by an open community with regular releases.
