...
The validation was performed on the entire output of the conversion pipeline, i.e.\ the full MPDT available at the time of writing, converted to UD (``MPDT-UD''). As described in Section~\ref{sec:resources}, the source corpus contains \textbf{2{,}018 sentences} and \textbf{47{,}273 tokens}, spanning the manually annotated portion of KorBa. All mentions in this chapter refer to this complete set.
