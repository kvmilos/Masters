...
MPDT-UD~1.0 is distributed within the Universal Dependencies project under the repository name \texttt{UD\_Polish-MPDT}. It was first released as part of the \textbf{UD~v2.17} release. The data are available both through the UD GitHub organization and via the standard UD release packages, alongside other Polish resources.
