...
\begin{figure}[H]
    ...
    \caption{MPDT analysis for the fragment \textit{siedzący na koniu rozpędzonym} (`sitting on a galloping horse')}
...
\begin{figure}[H]
    ...
    \caption{MPDT analysis for the fragment \textit{odwagi swoiey y sercá rycerskiego} (`of one's courage and knightly heart')}
...
\begin{figure}[H]
    ...
    \caption{MPDT analysis for the fragment \textit{Głową tego krolestwá iest Insułá} (`The head of this kingdom is Insułá')}
...
\begin{figure}[H]
    ...
    \caption{MPDT analysis for \textit{Dwa dni wisiał} (`He hung for two days')}
...
\begin{figure}[H]
  ...
  \caption{MPDT analysis for the fragment \textit{Są bowiem szczerzy, rzetelni, stateczni w przyjaźni} (`For they are sincere, reliable, steadfast in friendship')}
